...
//		context.drawTexture(RenderLayer::getGuiTextured, icon, x + padding, y + padding, iconWidth, iconHeight, -1);
		context.drawTexture(
...
//		context.drawGuiTexture(RenderLayer::getGuiTexturedOverlay, icon, x + padding, y + padding, 0, 0, width - (padding * 2), height - (padding * 2), iconWidth, iconHeight);
//		context.drawTexture(RenderLayer::getGuiTexturedOverlay, icon, x + padding, y + padding, 0, 0, width - (padding * 2), height - (padding * 2), iconWidth, iconHeight);
