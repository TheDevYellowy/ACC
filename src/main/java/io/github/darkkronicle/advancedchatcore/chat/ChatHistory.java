...
//			msg.originalText == message.originalText &&
//			message.creationTick - msg.creationTick >= 10)) return false;

		AdvancedChatCore.LOGGER.log(Level.INFO, "{} {} {}", message.originalText.getString(), ConfigStorage.General.CHAT_STACK.config.getIntegerValue(), messages.size());
		...
		return !message.isSimilar(messages.getLast());
	}
